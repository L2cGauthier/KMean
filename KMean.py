...
if __name__ == "__main__":
    ...
    dataSet[100:149, :] = 1 + np.random.rand(49,2)
    
    #We can reprent this as a scatter plot, with each constructed cluster associated with a color
    plt.scatter(dataSet[0:49, 0], dataSet[0:49, 1], s=20, c = 'b')
    plt.scatter(dataSet[50:99, 0], dataSet[50:99, 1], s=20, c = 'g')
